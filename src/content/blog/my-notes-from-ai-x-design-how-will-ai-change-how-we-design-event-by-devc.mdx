---
title: "my notes from  AI X Design  (how) will AI change how we design   event by DeVc"
description: "1/ With all the advancements in AI, the role of a designer remains the same = Biz Problems + User problems + User Behaviour."
pubDate: 2025-04-10
tags: ["AI", "LLMs", "design", "motivations", "vibe coding"]
draft: false
---
...
3/ With previous tools, a lot of time used to go into learning the tool → now it’s going to critical thinking.
...
Create a few graphics → Reverse engineer prompt for those images → Generalize the prompt → Create new graphics.
